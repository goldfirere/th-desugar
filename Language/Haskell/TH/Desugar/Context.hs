...
anyInstances _ [ConT name] | magicHashName name = return True
...
-- | I think this is how you recognize unlifted type names.
magicHashName :: Name -> Bool
magicHashName (Name (OccName s) _) = last s == '#'
